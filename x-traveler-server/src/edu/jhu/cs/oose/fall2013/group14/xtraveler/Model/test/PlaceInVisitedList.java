...
/**
 * To test if the place in ones visited list
 * @author kekekeng
 */
public class PlaceInVisitedList {
	...
	@Test	
	public void testPlaceInVisitedList() {
		...
		assertEquals("In the test has common visited people",true,tester.placeInVisitedList("paul", "Inner Harbor"));
