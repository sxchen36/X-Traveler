...
/**
 * This class is for testing if the two users have common interests
 * @author kekekeng
 */
public class CommonInterestTest {
	...
	@Test	
	public void testCommonInterested() {
		...
		assertEquals("In the test has common visited people","ray",tester2.listCommonVisitetPeople("paul").get(1));
